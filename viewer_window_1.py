...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cleanMessageView_bt = QtWidgets.QToolButton(self.centralwidget)
        self.cleanMessageView_bt.setGeometry(QtCore.QRect(650, 170, 27, 22))
        self.cleanMessageView_bt.setAutoFillBackground(False)
        self.cleanMessageView_bt.setStyleSheet("background-color: #e8ecf0;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.cleanContextView_bt = QtWidgets.QToolButton(self.centralwidget)
        self.cleanContextView_bt.setGeometry(QtCore.QRect(300, 170, 27, 22))
        ...
        self.search_in_currContext_chB = QtWidgets.QCheckBox(self.centralwidget)
        self.search_in_currContext_chB.setGeometry(QtCore.QRect(620, 30, 151, 20))
